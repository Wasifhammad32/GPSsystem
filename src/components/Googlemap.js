...
{!showPopup &&
   ...
   <img  className=" ml-4 w-6 h-6" src={right}/>
   </div>
 }
</div>
      <div style={{ position: "",width:"50%",top:"10px", border:"", transform: "translate(-50%, -50%)", zIndex: 1, textAlign: "center", color: "white" }}>
              <p className="text-black text-[20px] pt-3 flex justify-end font-extrabold"> <Link to="/leaflet" className="flex w-[50%] font-medium">
        Leaflet 
      </Link></p>
            </div>
...
<div className="border-2 w-[100%] relative flex  border-black">
<div className="\ ">
      {showPopup && <div id="trackingPopup"  className="sideBar  w-[400px] top-12  relative z-[100] ">
          <div className="pl-10 pt-2 pb-2 text-sm pr-3 w-[100%] flex justify-between">
            <div>
              <img className="w-6 h-6 m-auto" src={setting} />
              <caption className="flex ">Setting</caption>
            </div>
            <div>
              <img className="w-6 h-6 m-auto" src={alarm} />
              <caption className="flex ">Alarm</caption>
            </div>
            <div>
              <img className="w-6 h-6  hover:cur m-auto" src={msg} />
              <caption className="flex ">Message</caption>
            </div>
            <div>
              <img onClick={togglePopupp} className="w-5  h-5 mt-2 m-auto" src={left} />
            </div>
          </div>
          <div className="flex">
            ...
            <div className="pl-2 pr-2 w-[20%] flex border-y-2 justify-between">
              <img className="w-5 mt-2 h-5 " src={search} />
              <img className="w-4 mt-2 h-4 " src={burger} />
            </div>
          </div>
          <div className="pl-2">
            <div className="flex">
              <img className="w-4 mt-2 h-4" src={right} />
            ...
            <div className="flex">
              <img className="w-4 mt-2 h-4" src={flag} />
              <input className="ml-2 mt-1" type="checkbox" />
          ...
          <div className="mt-2 ">
            ...
            <div className="border-t-2 border-gray-400 px-4">
              <div className="border-t-2 px-6 pt-4 pb-8 flex justify-between border-green-400">
                <p className="text-sm">Total:<span className="text-blue-500">168</span></p>
                <p className="text-sm">Online:<span className="text-blue-500">125</span></p>
                <p className="text-sm">Offline:<span className="text-blue-500">43</span></p>
 ...
 <div className="map w-[100%] " style={{ position: "",left: "30%", border: "", width: "1360px", height: "500px", marginTop: "50px" }}>
        {!isLoaded ? (
          <h1>Loading...</h1>
        ) : (
          <>
