...
const Leafletmap = () => {
  ...
  return (
    <div className="Screen relative">
      ...
      <div className="pl-10 linkClass w-[100%] button flex justify-between absolute z-50 ">
...
{!showPopup &&
   ...
   <img  className=" ml-4 w-6 h-6" src={right}/>
        ...
        <Link to="/"  className="flex w-[50%]  font-medium   ">
        Google Map
        </Link>
      </div>
      ...
      <div className="\ ">
      {showPopup && <div id="trackingPopup"  className="sideBar  w-[400px] top-28 relative z-[100] ">
          ...
          <div className="mt-2 ">
            {/* <div className="flex ml-3 mt-3 mb-3  border-2 border-gray-400 rounded-md w-[92%] ">
            ...
            {/* <div className="flex ml-3 mt-3 mb-3 border-2 bg-green-300 border-gray-400 rounded-md w-[92%] ">
              <input className="ml-1 mt-1 " type="checkbox" />
              <div className="ml-2 ">
                <div className="w-10 mt-1 m-auto h-10 border-2 rounded-full border-gray-700">
                  <img className="w-7  mt-1 h-7 m-auto" src={car} />
